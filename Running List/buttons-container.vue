<template>
    <div>
        ...
        <div v-for="button in buttons" class="filter-button" :class="[filter.current==button.value ? '' : 'invisibility']" @click="filter.current=button.value">
            {{button.name}}
...
<style scoped>
    ...
    .filter-button.invisibility .material-icons {
        color: black;
    }
