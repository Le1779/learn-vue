    ...
    module.exports = {
        ...
        methods: {
            ...
            selectEmployee(item) {
                ...
                if (!item.isLeader) {
                    this.findDepartmentLeaderAndSelect(this.currentDepartment, item.selected)
                }
            },
            ...
            findDepartmentLeaderAndSelect(department, selected) {
                let self = this
                department.member.forEach(function(item, index, array) {
                    if (item.isLeader) {
                        if (selected) {
